...
const schoolsDetails = {
    INTERFACE: {
        1: {
            ...
            room: 'Синяя',
            date: new Date(2017, 1, 20, 18, 0),
            dateView: formatDate(new Date(2017, 1, 20, 18, 0)),
            timeView: formatTime(new Date(2017, 1, 20, 18, 0)),
        ...
        2: {
            ...
            speaker: 'Дмитрий Душкин',
            room: 'Синяя',
            date: new Date(2017, 1, 28, 18, 0),
            dateView: formatDate(new Date(2017, 1, 28, 18, 0)),
            timeView: formatTime(new Date(2017, 1, 28, 18, 0)),
        ...
        3: {
            ...
            room: 'Просторная',
            date: new Date(2017, 1, 25, 18, 0),
            dateView: formatDate(new Date(2017, 1, 25, 18, 0)),
            timeView: formatTime(new Date(2017, 1, 25, 18, 0)),
            materials: 'materials2',
            video: 'video2'
        },
        4: {
